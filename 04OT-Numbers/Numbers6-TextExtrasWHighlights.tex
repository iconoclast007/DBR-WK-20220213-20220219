...
\begin{figure}
  \includegraphics[width=\linewidth]{04OT-Numbers/Numbers6-WordCloud.jpg}
  \caption{Numbers 6 Word Cloud}
  \label{fig:Numbers 6 word Cloud}
\end{figure}



\marginpar{\scriptsize \centering \fcolorbox{bone}{lime}{\textbf{THE NAZARITE VOW}}\\ (Numbers  6:1-27)

\begin{compactenum}[I.][8]
    \item A \textbf{Special} Vow %\index[scripture]{Numbers!Numbers 05:02}(Numbers 5:2) 
    \item \textbf{Separated}  \index[scripture]{Numbers!Num 06:02}(Numbers 6:2) 
    \item Sometimes for a \textbf{Specific}  Time or Purpose %\index[scripture]{Numbers!Numbers 05:02}(Numbers 5:2) 
    \item A \textbf{Sign}  %\index[scripture]{Numbers!Numbers 05:02}(Numbers 5:2) 
    \item \textbf{Sanctified}  %\index[scripture]{Numbers!Numbers 05:16}(Numbers 5:16) 
    \item \textbf{Set Apart}  % \index[scripture]{Numbers!Numbers 05:27--28}(Numbers 5:27--28) 
    \item \textbf{Strict}  % \index[scripture]{Numbers!Numbers 05:27--28}(Numbers 5:27--28) 
\end{compactenum}}




\footnote{\textcolor[cmyk]{0.99998,1,0,0}{\hyperlink{TOC}{Return to end of Table of Contents.}}}\footnote{\href{https://audiobible.com/bible/numbers_6.html}{\textcolor[cmyk]{0.99998,1,0,0}{Numbers 6 Audio}}}\textcolor[cmyk]{0.99998,1,0,0}{And the LORD spake unto Moses, saying,}
...
[14] \textcolor[cmyk]{0.99998,1,0,0}{And he shall offer his offering unto the LORD, one he lamb of the first year without blemish for a burnt offering, and one ewe lamb of the first year without blemish for a sin offering, and one ram without blemish for peace offerings,}
